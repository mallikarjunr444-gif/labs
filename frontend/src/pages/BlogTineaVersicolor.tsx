...
const BlogTineaVersicolor: React.FC = () => (
  <>
    <SEO
      title="Tinea Versicolor (Pityriasis Versicolor): Malassezia Hyphae & Anti-Fungal Care | Medicus Labs"
      description="Clinical guide on Tinea Versicolor: Malassezia globosa yeast dimorphism, azelaic acid melanocyte inhibition, hypopigmented macules, selenium sulfide, and AI pre-screening."
    />
    <div className="min-h-screen bg-[#FAF9F5] text-[#141515] pt-32 selection:bg-[#206E55]/20 font-sans">
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        <Breadcrumbs items={[{ label: 'Blog', href: '/blog' }, { label: 'Tinea Versicolor' }]} />
        ...
        <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#E8F2ED] border border-[#206E55]/20 text-[#206E55] text-xs font-bold uppercase tracking-widest mb-6">
          <Sparkles size={12} /> Fungal Dermatology Guide • ICD-11: 1F2D
        </span>

        <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-[#141515] mb-6 leading-tight">
          Tinea Versicolor: Malassezia Dimorphism, Melanogenesis Inhibition &amp; Topical Antifungals
        </h1>
        ...
        <div className="prose prose-slate max-w-none text-[#5A554A] space-y-8 leading-relaxed">
          <div className="bg-[#E8F2ED]/60 border border-[#206E55]/20 rounded-3xl p-6 sm:p-8">
            ...
            <ul className="grid sm:grid-cols-2 gap-3 text-sm text-[#141515]">
              <li className="flex items-start gap-2"><CheckCircle2 size={16} className="text-[#206E55] mt-1 shrink-0" /><span><strong>Pathology:</strong> Benign superficial fungal infection caused by dimorphic yeast <em>Malassezia globosa</em>.</span></li>
              <li className="flex items-start gap-2"><CheckCircle2 size={16} className="text-[#206E55] mt-1 shrink-0" /><span><strong>Mechanism of Hypopigmentation:</strong> Dicarboxylic acids (azelaic acid) produced by yeast inhibit tyrosinase.</span></li>
              <li className="flex items-start gap-2"><CheckCircle2 size={16} className="text-[#206E55] mt-1 shrink-0" /><span><strong>Microscopy:</strong> "Spaghetti and meatballs" appearance (short curved hyphae + round yeast cells) on KOH.</span></li>
              <li className="flex items-start gap-2"><CheckCircle2 size={16} className="text-[#206E55] mt-1 shrink-0" /><span><strong>Therapy:</strong> Selenium sulfide 2.5% wash, Ketoconazole 2% shampoo, or single-dose oral fluconazole.</span></li>
            </ul>
          </div>

          <section>
            <h2 className="text-2xl font-bold text-[#141515] mb-4">1. Overview &amp; Fungal Dimorphism</h2>
          ...
          <section className="pt-8 border-t border-[#E5E2DA]">
            ...
            <ol className="list-decimal pl-6 text-xs text-[#8A857A] space-y-1.5 font-mono">
              <li>Kallini JR, et al. Tinea versicolor: a update on pathogenesis and management. <em>Cutis.</em> 2014;93(2):78-84.</li>
              <li>WHO ICD-11 Code 1F2D: Pityriasis Versicolor. World Health Organization, 2024.</li>
            </ol>
          </section>
        </div>
        ...
        <div className="mt-14 p-8 rounded-3xl bg-gradient-to-br from-[#E8F2ED] via-white to-[#F3F1EB] border border-[#206E55]/30 text-center shadow-sm">
          <h3 className="text-2xl font-extrabold text-[#141515] mb-2">Check Discolored Chest &amp; Back Spots</h3>
          <p className="text-sm text-[#5A554A] max-w-xl mx-auto mb-6">Upload photos of hypopigmented patches for AI fungal evaluation.</p>
...
export default BlogTineaVersicolor;
